...
- **<!--Cashu-and-other-ecash-system-design-discussion-->Cashu 和其他 ecash 系统设计讨论：** 几周前，开发者 Thunderbiscuit 在 Delving Bitcoin 上[发布了][thunderbiscuit ecash]关于 [Chaumian ecash][]系统背后的[盲签名方案][]的描述，该系统在 [Cashu][]中使用，以 satoshis 作为余额单位，允许使用比特币和 LN 进行货币发送和接收。开发者 Moonsettler 和 Zmnscpxj 本周的回复讨论了盲签名简化版本的一些限制，以及如何通过备选协议可能提供额外好处。讨论完全是理论性的，但我们认为对于对 ecash 系统感兴趣的人来说可能会很有趣。 {% assign timestamp="29:15" %}
