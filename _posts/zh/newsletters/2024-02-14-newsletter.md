...
- **<!--i-love-free-software-day-->我爱自由软件节**：每年的 2 月 14 日，[FSF][] 和 [FSFE][] 这样的组织都会鼓励自由和开源软件（FOSS）的用户 “向所有维护和为自由软件贡献的人高喊 ‘谢谢你！’”。即使你在 2 月 14 日之后才读到本刊，我们依然鼓励拨出片刻，向你最喜欢的比特币 FOSS 项目的贡献者们表示感谢。
